...
side_holes = [['label',     'position', 'chimney',  'radius',   'radius_out'],
              [emb_label,   0.03,      5e-3,        5e-3,       Remb_out], # the embouchure hole
               ['hole1',     0.265,       3e-3,       4e-3,       4e-3],
               ['hole2',     0.297,       3e-3,       4e-3,       4e-3],
               ['hole3',     0.334,       3e-3,       4e-3,       4e-3],
               ['hole4',     0.375,       3e-3,       4e-3,       4e-3],
               ['hole5',     0.397,       3e-3,       4e-3,       4e-3],
               ['hole6',     0.445,       3e-3,       4e-3,       4e-3],
              ]
...
fing_chart2 = [['label',     'C', 'D', 'E', 'F', 'G', 'A', 'B'],
              ['hole1',     'x', 'x', 'x', 'x', 'x', 'x', 'o'],
              ['hole2',     'x', 'x', 'x', 'x', 'x', 'o', 'o'],
              ['hole3',     'x', 'x', 'x', 'x', 'o', 'o', 'o'],
              ['hole4',     'x', 'x', 'x', 'o', 'o', 'o', 'o'],
