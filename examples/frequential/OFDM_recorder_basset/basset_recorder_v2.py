...
geom = [[0, 0.981+0.016-0.04, Rp, Rp, "cone"]]
temperature = 25
...
new_params = {"section": np.pi * Rw**2,
              ...
              "wall_thickness": 2e-3,# the wall thickness in meter
              }
...
side_holes = [['label',     'position',  'chimney',  'radius', 'radius_out'],
              [emb_label,    0.01,        2e-3,       7.8e-3,     Remb_out], # the embouchure hole
               ['hole1',     oSet+0.383+0.075,       2.8e-3,       6e-3,     6e-3],
               ['hole2',     oSet+0.455+0.063,       2.8e-3,       6e-3,     6e-3],
               ['hole3',     oSet+0.535+0.056,       2.8e-3,       6e-3,     6e-3],
               ['hole4',     oSet+0.625+0.05,       2.8e-3,       6e-3,     6e-3],
               ['hole5',     oSet+0.705+0.005,       2.8e-3,       6e-3,     6e-3],
               ['hole6',     oSet+0.777+0.025,       2.8e-3,       6e-3,     6e-3],
              ]
