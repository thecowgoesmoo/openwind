...
Rw = 10e-3 #4e-3  # the equivalent radius of the window
...
side_holes = [['label',     'position',  'chimney',  'radius', 'radius_out'],
               ['hole1',     0.623b v,       2.0e-3,       12e-3,     12e-3],
               ['hole2',     0.710,       2.0e-3,       12e-3,     12e-3],
               ['hole3',     0.805,       2.0e-3,       12e-3,     12e-3],
               ['hole4',     0.920,       2.0e-3,       12e-3,     12e-3],
               ['hole5',     0.970,       2.0e-3,       12e-3,     12e-3],
               ['hole6',     1.100,       2.0e-3,       12e-3,     12e-3],
              ]              
...
tgtFreqs = np.power(2,np.divide([0,2,4,5,7,9,11],12))*130.8
