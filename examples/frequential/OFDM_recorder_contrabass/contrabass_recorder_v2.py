...
Rw = 25e-3 #4e-3  # the equivalent radius of the window
...
side_holes = [['label',     'position',  'chimney',  'radius', 'radius_out'],
               ['hole1',     0.814,       6.0e-3,       6e-3,     6e-3],
               ['hole2',     0.934,       6.0e-3,       6e-3,     6e-3],
               ['hole3',     1.073,       6.0e-3,       6e-3,     6e-3],
               ['hole4',     1.293,       6.0e-3,       6e-3,     6e-3],
               ['hole5',     1.318,       6.0e-3,       6e-3,     6e-3],
               ['hole6',     1.510,       6.0e-3,       6e-3,     6e-3],
              ]              
