...
side_holes = [['label',     'position',  'chimney',  'radius', 'radius_out'],
               ['hole1',     1.58*0.585,       2.0e-3,       6e-3,     6e-3],
               ['hole2',     1.57*0.665,       2.0e-3,       6e-3,     6e-3],
               ['hole3',     1.56*0.765,       2.0e-3,       6e-3,     6e-3],
               ['hole4',     1.56*0.880,       2.0e-3,       6e-3,     6e-3],
               ['hole5',     1.57*0.922,       2.0e-3,       6e-3,     6e-3],
               ['hole6',     1.55*1.045,       2.0e-3,       6e-3,     6e-3],
              ]              
