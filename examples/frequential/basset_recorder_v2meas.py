...
#side_holes = [['label',     'position',  'chimney',  'radius', 'radius_out'],
#              [emb_label,    0.01,        2e-3,       3.3e-3,     Remb_out], # the embouchure hole
#               ['hole1',     0.475,       2.0e-3,       5.5e-3,     5.5e-3],
#               ['hole2',     0.535,       2.0e-3,       5.5e-3,     5.5e-3],
#               ['hole3',     0.645,       2.0e-3,       5.5e-3,     5.5e-3],
#               ['hole4',     0.705,       2.0e-3,       5.5e-3,     5.5e-3],
#               ['hole5',     0.765,       2.0e-3,       5.5e-3,     5.5e-3],
#               ['hole6',     0.835,       2.0e-3,       5.5e-3,     5.5e-3],
#              ]

side_holes = [['label',     'position',  'chimney',  'radius', 'radius_out'],
               ['hole1',     0.475+0.013,       2.0e-3,       5.5e-3,     5.5e-3],
               ['hole2',     0.535+0.013,       2.0e-3,       5.5e-3,     5.5e-3],
               ['hole3',     0.645+0.013,       2.0e-3,       5.5e-3,     5.5e-3],
               ['hole4',     0.705+0.013,       2.0e-3,       5.5e-3,     5.5e-3],
               ['hole5',     0.765+0.013,       2.0e-3,       5.5e-3,     5.5e-3],
               ['hole6',     0.835+0.013,       2.0e-3,       5.5e-3,     5.5e-3],
              ]              
...
tgtFreqs = np.power(2,np.divide([0,2,4,5,7,9,11],12))*174.6
