...
Rw = 7e-3 #4e-3  # the equivalent radius of the window
...
side_holes = [['label',     'position',                   'chimney',  'radius',         'radius_out'],
              [emb_label,    0.03,                        5e-3,        5e-3,            Remb_out], # the embouchure hole
               ['hole0',     1.11*2*5.4*25.4*0.001,        3e-3,       1.4*4e-3,       1.4*4e-3],
               ['hole1',     1.11*2*5.75*25.4*0.001,       3e-3,       1.4*3e-3,       1.4*3e-3],
               ['hole2',     1.11*2*6.9*25.4*0.001,        3e-3,       1.4*3.5e-3,     1.4*3.5e-3],
               ['hole3',     1.11*2*8.25*25.4*0.001,       3e-3,       1.4*3.5e-3,     1.4*3.5e-3],
               ['hole4',     1.11*2*9.625*25.4*0.001,      3e-3,       1.4*2.75e-3,    1.4*2.75e-3],
               ['hole5',     1.11*2*10.95*25.4*0.001,      3e-3,       1.4*3.5e-3,     1.4*3.5e-3],
               ['hole6a',    1.11*2*11.9*25.4*0.001,       3e-3,       1.4*1.25e-3,    1.4*2.5e-3],
               ['hole6b',    1.11*2*12.1*25.4*0.001,       3e-3,       1.4*4e-3,       1.4*1.25e-3],
               ['hole7a',    1.11*2*13.15*25.4*0.001,      3e-3,       1.4*2.5e-3,     1.4*2.5e-3],
               ['hole7b',    1.11*2*13.35*25.4*0.001,      3e-3,       1.4*1.25e-3,    1.4*1.25e-3],
              ]
